...
<body>
	...
	<div style="background-color: #E6F2F8;">
		<form action="admin_db_test.php" method="post">
			<table>
				<tr>
					<td colspan="2">
						<p style="font-size: 35px; color: #094198;"><b>Admin Login</b></p>
					</td>
				</tr>
				<tr>
		...
		<table>
			...
			<tr>
				<td><button type="button"><a style="text-decoration: none;  font-size: 25px;" href="admin_signup_test.php">User SignUp</a></button></td>
				<td><button type="button"><a style="text-decoration: none; font-size: 25px;" href="admin_forgot_pwd_test.php">Forgot Password</a></button></td>
			</tr>
		</table>
	</div>
</body>
