...
<body style="background: #f2f2f2;">
    ...
    <ul>
        <li><a href="index_test.php">HOME</a>
        <li><a href="admin_login_test.php">ADMIN LOGIN</a></li>
        <li><a href="user_login.php">USER LOGIN</a></li>
        <li><a href="#rooms_and_rates">ROOM GALLERY</a></li>
        <li><a href="image_gallery_test.php">IMAGE GALLERY</a>
    ...
    function showSlides() {
        ...
        slideindex_test++;
        if (slideindex_test > slides.length) {
            slideindex_test = 1
        }
        for (i = 0; i < dots.length; i++) {
            dots[i].className = dots[i].className.replace(" active", "");
        }
        slides[slideindex_test - 1].style.display = "block";
        dots[slideindex_test - 1].className += " active";
