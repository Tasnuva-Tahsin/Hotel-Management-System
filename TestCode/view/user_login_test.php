...
<body>
	...
	<div style="background-color: #E6F2F8;">
		<form action="user_logged_in_test.php" method="post">
			<table>
				<tr>
					<td colspan="2">
						<p style="font-size: 35px; color: #094198;"><b>User Login</b></p>
					</td>
				</tr>
				<tr>
					<td>Phone number:</td>
		...
		<table>
			...
			<tr>
				...
				<td><button type="button"><a style="text-decoration: none;  font-size: 25px;" href="user_forgot_pwd_test.php">Forgot Password</a></button></td>
			</tr>
		</table><br>
	</div>
</body>
